...
# main algorithm
def random_walk(edges_file: Path, sources_file: Path, targets_file: Path, output_file: Path, damping_factor : float = 0.85, selection_function : str = 'min', threshold : float = 0.001):
    """
    ...
    print(f"Source node: {len(source_node)}")
